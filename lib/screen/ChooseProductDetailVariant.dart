    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: mTop(
          ...
          showBack: true,
          actions: [
            Image.asset(ic_home, height: 20, width: 20, color: white).onTap(() {
  ...
  Widget itemWidget({required Function onTap, String? title, int code = 1, String? img}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) == code ? primaryColor! : Theme.of(context).dividerColor),
      ),
      child: Stack(
        fit: StackFit.expand,
        children: [
          ...
          AnimatedContainer(duration: Duration(milliseconds: 800), color: getIntAsync(PRODUCT_DETAIL_VARIANT, defaultValue: 1) == code ? transparentColor : Colors.black45).cornerRadiusWithClipRRect(8),
          AnimatedContainer(
