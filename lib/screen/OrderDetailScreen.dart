      ...
      if (widget.mOrderModel!.status == COMPLETED ||
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [Text(appLocalization.translate('lbl_cancel_order')!, style: primaryTextStyle(color: primaryColor)), Icon(Icons.chevron_right)],
            ),
          ),
        );
      }
    ...
    Widget mBody(BuildContext context) {
      return SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            16.height,
            commonCacheImageWidget(widget.mOrderModel!.lineItems![0].productImages![0].src, height: 140, width: 140, fit: BoxFit.cover).cornerRadiusWithClipRRect(10).center(),
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  spacing_standard.height,
                  Text(appLocalization.translate('lbl_other_item_in_cart')!, style: boldTextStyle(size: 16)),
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              commonCacheImageWidget(widget.mOrderModel!.lineItems![i].productImages![0].src.validate(), height: 80, width: 80, fit: BoxFit.cover).cornerRadiusWithClipRRect(8),
                              Expanded(
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        PriceWidget(
                                            price: widget.mOrderModel!.lineItems![i].total.toString(), size: textSizeLargeMedium.toDouble(), color: Theme.of(context).textTheme.subtitle1!.color),
                                        Text(
                                ...
                                ).paddingOnly(left: spacing_standard.toDouble(), top: spacing_control.toDouble()),
                              )
                            ],
                          ),
                        ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(appLocalization.translate('lbl_Shipping')!, style: secondaryTextStyle(color: Theme.of(context).textTheme.subtitle2!.color, size: 16)),
                      PriceWidget(price: widget.mOrderModel!.shippingTotal.isNotEmpty ? widget.mOrderModel!.shippingTotal : "Free", size: 16, color: Theme.of(context).textTheme.subtitle2!.color),
                    ],
                  ),
                  Divider(),
                  Row(
