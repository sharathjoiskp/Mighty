    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        return Column(
          ...
          children: [
            Text(mainProduct!.attributes![i].name, style: primaryTextStyle()).visible(mainProduct!.attributes![i].options!.isNotEmpty),
            8.height.visible(mainProduct!.attributes!.isNotEmpty),
...
// API calling for remove cart
      ...
      return Column(
        ...
        children: [
          Text(
            ...
            style: boldTextStyle(),
          ).paddingOnly(left: spacing_standard_new.toDouble(), right: spacing_standard_new.toDouble(), bottom: 4).visible(mReviewModel.isNotEmpty),
          ListView.separated(
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(appLocalization.translate("lbl_view_all_review")!, style: boldTextStyle(color: Theme.of(context).accentColor)),
              ...
              .paddingAll(16)
              .visible(mReviewModel.length >= 3 && mainProduct!.reviewsAllowed == true),
        ],
      );
    }
    ...
    Widget upSaleProductList(List<UpsellId> product) {
      ...
      return Column(
        ...
        children: <Widget>[
          ...
          Container(
            margin: EdgeInsets.only(top: spacing_control.toDouble()),
            height: 320,
                    ...
                    child: Column(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(product[i].name!, style: primaryTextStyle(size: textSizeSMedium), maxLines: 2, overflow: TextOverflow.ellipsis),
    ...
    Widget mGroupAttribute(List<ProductDetailResponse> product) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text(appLocalization!.translate('lbl_product_Involve')!, style: boldTextStyle()).paddingOnly(left: 12, top: spacing_standard.toDouble()),
          ListView.builder(
              physics: NeverScrollableScrollPhysics(),
              scrollDirection: Axis.vertical,
              shrinkWrap: true,
              ...
              itemBuilder: (context, i) {
                return GestureDetector(
                  ...
                  child: Container(
                    padding: EdgeInsets.only(right: spacing_standard.toDouble(), top: spacing_standard.toDouble(), bottom: spacing_standard.toDouble()),
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
        ...
        ? GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  mIsInWishList == false ? Icon(Icons.favorite_border, color: primaryColor) : Icon(Icons.favorite, color: redColor),
                ],
              ),
            ),
    ...
    final mCartData = mainProduct != null
        ? GestureDetector(
            ...
            child: Container(
              ...
              decoration:
                  boxDecorationWithRoundedCorners(borderRadius: BorderRadius.circular(8), backgroundColor: mainProduct!.inStock! ? context.primaryColor : textSecondaryColorGlobal.withOpacity(0.3)),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
          ...
          if (value > 0) {
            return Row(
              children: [
                ...
                PriceWidget(price: value.toStringAsFixed(2), size: textSizeMedium.toDouble(), color: greenColor)
              ],
                    ...
                    Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(mainProduct!.name!, style: boldTextStyle(size: 18)).paddingOnly(left: 12, right: 12).expand(),
                        ...
                        ).paddingOnly(top: 4, left: 12).visible(!mainProduct!.type!.contains("grouped")),
                        ...
                        if (mainProduct!.store != null)
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  8.width,
                                  Text(mainProduct!.store!.shopName != null ? mainProduct!.store!.shopName.validate() : '', style: boldTextStyle(color: primaryColor)),
                                ],
                              ),
                              8.width,
                          ...
                          }).visible(mainProduct!.store!.shopName.validate() != null),
                        ...
                        HtmlWidget(postContent: mainProduct!.shortDescription).paddingOnly(left: 6, right: 6).visible(mainProduct!.shortDescription.toString().isNotEmpty),
                        Text(appLocalization.translate('lbl_shop_category')!, style: boldTextStyle()).paddingOnly(left: 12, right: 12, top: spacing_standard.toDouble()),
                        4.height,
                        Wrap(
                          children: mainProduct!.categories!.map((e) {
                            // int cIndex = mainProduct!.categories!.indexOf(e);
                            return Container(
