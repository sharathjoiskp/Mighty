...
class HtmlWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    "strong,div,h1,h2,h3,h4,h5,h6,figure,ol,ul,strike,u,b,i,hr,header,code,data,body,big,blockquote": Style(color: Theme.of(context).textTheme.subtitle1!.color, fontSize: FontSize(16)),
        'embed': Style(color: color ?? transparentColor, fontStyle: FontStyle.italic, fontWeight: FontWeight.bold, fontSize: FontSize(14)),
        'a': Style(color: color ?? Colors.blue, fontWeight: FontWeight.bold, fontSize: FontSize(14)),
        'img': Style(width: context.width(), padding: EdgeInsets.only(bottom: 8), fontSize: FontSize(14)),
      },
    );
  }
}
